...
def create_stratified_kfold(n_splits: int = 5, random_state: int = 0) -> StratifiedKFold:
    """
...
def optimize_random_forest(X_train: pd.DataFrame, y_train: pd.Series, n_trials: int = 100) -> dict:
    """
...
def optimize_xgboost(X_train: pd.DataFrame, y_train: pd.Series, n_trials: int = 100) -> dict:
    """
...
def optimize_lightgbm(X_train: pd.DataFrame, y_train: pd.Series, n_trials: int = 100) -> dict:
    """
...
def optimize_logistic_regression(X_train: pd.DataFrame, y_train: pd.Series, n_trials: int = 10) -> dict:
    """
